...
exports.FrameHandler = exports.StreamCursor = void 0;
...
class StreamCursor {
    ...
    processFrame(frame) {
        ...
        if (frame.kind === 'patch' && frame.base && state.stateHash) {
            if (!(0, hash_1.verifyBase)(state.stateHash, frame.base)) {
                throw new types_1.BaseMismatchError();
            }
        }
        // Update sequence
    ...
    setState(sid, value) {
        ...
        state.state = value;
        state.stateHash = (0, hash_1.stateHashLooseSync)(value);
    }
    /**
...
exports.FrameHandler = FrameHandler;
